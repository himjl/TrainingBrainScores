...
"""This is not intended to be run -- just a starting point for building your brainscore wrapper for tf.keras models (for tf > 2.0)"""

"""Example usage: 
    
    activations_model = TFKerasWrapper(model,
